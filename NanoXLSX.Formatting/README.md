...
NanoXLSX.Formatting contains the components for advance cell formatting.

## Dependencies

The formatting packages has the following dependencies:
...
For changes of the formatting package, please see **[library change log](https://github.com/rabanti-github/NanoXLSX.Formatting/blob/master/NanoXLSX.Formatting/Changelog.md)** or the **[main change log](https://github.com/rabanti-github/NanoXLSX/blob/master/Changelog.md)**.
